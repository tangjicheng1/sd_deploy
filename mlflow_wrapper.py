...
with mlflow.start_run() as run:  
    mlflow.pyfunc.log_model(
        ...
        signature=signature,
        code_path=["/Workspace/Repos/tang.j@ctw.inc/sd_deploy", "/Workspace/Repos/tang.j@ctw.inc/sd_deploy/modules", "/Workspace/Repos/tang.j@ctw.inc/sd_deploy/webui_wrapper.py"],
