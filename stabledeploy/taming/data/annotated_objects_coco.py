...
from stabledeploy.taming.data.annotated_objects_dataset import AnnotatedObjectsDataset
from stabledeploy.taming.data.helper_types import Annotation, ImageDescription, Category
